...
use common\assets\UnifyThemeAsset;
...
<head>
    ...
    <link rel="stylesheet" href="<?=$custom->baseUrl?>/plugins/sky-forms-pro/skyforms/css/sky-forms.css">
    <link rel="stylesheet" href="<?=$custom->baseUrl?>/plugins/sky-forms-pro/skyforms/custom/custom-sky-forms.css">
    <?php $this->head() ?>
...
<script src="<?=$custom->baseUrl?>/plugins/sky-forms-pro/skyforms/js/jquery.maskedinput.min.js"></script>
<script src="<?=$custom->baseUrl?>/plugins/sky-forms-pro/skyforms/js/jquery-ui.min.js"></script>
<script src="<?=$custom->baseUrl?>/plugins/sky-forms-pro/skyforms/js/jquery.validate.min.js"></script>
<!-- JS Customization -->
